...
class ModuleMakeBackendControllerCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-backend-controller';
    ...
    public function getDestinationFilePath()
    {
        ...
        $controllerPath = Modules::config('paths.generator.controller');

        return $path.$controllerPath.'/Backend/'.$this->getControllerName().'.php';
    }
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub('/backend-controller.stub', [
    ...
    {
        return 'Http\Controllers\Backend';
    }
}
