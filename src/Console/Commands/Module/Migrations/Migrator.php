...
namespace ZEDx\Console\Commands\Module\Migrations;
...
class Migrator
{
    ...
    {
        $files = File::glob($this->getPath().'/*_*.php');
    ...
    public function requireFiles(array $files)
    {
        ...
        foreach ($files as $file) {
            File::requireOnce($path.'/'.$file.'.php');
        }
    }
    ...
    {
        return DB::table(config('database.migrations'));
    }
