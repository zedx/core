...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $my_account = $this->create('Mon compte', 'Mon compte', 'user', 'fa fa-user', 'user.edit', 'route');

        $user_my_ads = $this->create('Mes annonces', 'Mes annonces', 'user-header', 'fa fa-list-alt', 'user.ad.index', 'route');
        $user_add_new_ad = $this->create('Ajouter une annonce', 'Ajouter une annonce', 'user-header', 'fa fa-plus', 'user.adtype.index', 'route');
        $user_header_my_account = $this->create('Mon compte', 'Mon compte', 'user-header', 'fa fa-user', 'user.edit', 'route');
